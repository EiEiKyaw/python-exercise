...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            get the blmb out. If you get the code wrong 10 times then
        ...
        if guess == code:
            print(dedent("""
                ...
                gas out. You rab the neutron bomb and run as fast as
